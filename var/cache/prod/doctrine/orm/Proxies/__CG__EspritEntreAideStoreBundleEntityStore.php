 ...
 */
class Store extends \EspritEntreAide\StoreBundle\Entity\Store implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EspritEntreAide\\StoreBundle\\Entity\\Store' . "\0" . 'id', '' . "\0" . 'EspritEntreAide\\StoreBundle\\Entity\\Store' . "\0" . 'idUser', '' . "\0" . 'EspritEntreAide\\StoreBundle\\Entity\\Store' . "\0" . 'etat'];
        }
