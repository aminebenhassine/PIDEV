 ...
 */
class Reponse extends \EspritEntreAide\AnnonceBundle\Entity\Reponse implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EspritEntreAide\\AnnonceBundle\\Entity\\Reponse' . "\0" . 'id', '' . "\0" . 'EspritEntreAide\\AnnonceBundle\\Entity\\Reponse' . "\0" . 'idUser', '' . "\0" . 'EspritEntreAide\\AnnonceBundle\\Entity\\Reponse' . "\0" . 'idAnnonce', '' . "\0" . 'EspritEntreAide\\AnnonceBundle\\Entity\\Reponse' . "\0" . 'contenu', '' . "\0" . 'EspritEntreAide\\AnnonceBundle\\Entity\\Reponse' . "\0" . 'dateCreation', '' . "\0" . 'EspritEntreAide\\AnnonceBundle\\Entity\\Reponse' . "\0" . 'dateModif'];
        }
