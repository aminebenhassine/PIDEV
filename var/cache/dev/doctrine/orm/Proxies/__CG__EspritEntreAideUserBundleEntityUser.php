...
class User extends \EspritEntreAide\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'EspritEntreAide\\UserBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'EspritEntreAide\\UserBundle\\Entity\\User' . "\0" . 'prenom', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
